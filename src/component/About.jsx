const About = () => {
  return (
    <div className="bg-red-50 font-bold mt-10 w-[1280px] mb-10 text-center justify-center mx-auto">
      <h1 className="text-center text-4xl pt-10 font-bold pb-5">About Me</h1>
      ...
      <div className="flex justify-center gap-5 pt-5 pb-10">
        <div className="">
          ...
          <p className="">Maruf Hasan Siyam</p>
        </div>
        <div className="">
          <h4 className="">Email:</h4>
          <p className="">Marufhasansiyam6@gmail.com</p>
        </div>
        <div className="">
          <h4 className="">Date of birth:</h4>
          <p className="">3 july 2002</p>
        </div>
        <div className="">
